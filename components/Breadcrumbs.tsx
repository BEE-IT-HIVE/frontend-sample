...
const Breadcrumbs: React.FC<BreadcrumbsProps> = ({ currentPage, detail, onNavigate }) => {
  ...
  return (
    <div className={`fixed left-0 right-0 z-40 bg-gray-50/90 dark:bg-hive-blue/90 backdrop-blur-sm border-b border-gray-100 dark:border-white/5 shadow-sm transition-all duration-300 ${currentPage === Page.Admin ? 'top-16' : 'top-16'}`}>
